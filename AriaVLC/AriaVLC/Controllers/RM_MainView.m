...
- (void)loadView
{
    ...
    [ariaSymbol setAlphaValue:RMDragAnimationOutAlpha];
...
- (void)registerNotification
{
    ...
    [defaultCenter addObserver:self selector:@selector(expandDragBox:) name:RMDashedBoxDragOperationStartedNotification object:nil];
    [defaultCenter addObserver:self selector:@selector(restoreDragBox:) name:RMDashedBoxDragOperationEndedNotification object:nil];
    [defaultCenter addObserver:self selector:@selector(restoreDragBox:) name:RMDashedBoxDragOperationDroppedNotification object:nil];
}
...
- (void)expandDragBox:(NSNotification *)notification
{
    NSSize expandendSize = NSMakeSize(dashedBorder.bounds.size.width + RMDragAnimationDashedBoxGrowth,
                                      dashedBorder.bounds.size.width + RMDragAnimationDashedBoxGrowth);
    ...
    [[NSAnimationContext currentContext] setDuration:RMDragAnimationDuration];
    ...
    [[ariaSymbol animator] setAlphaValue:RMDragAnimationInAlpha];
...
- (void)restoreDragBox:(NSNotification *)notification
{
    NSSize restoredSize = NSMakeSize(dashedBorder.bounds.size.width - RMDragAnimationDashedBoxGrowth,
                                     dashedBorder.bounds.size.width - RMDragAnimationDashedBoxGrowth);
    ...
    [[ariaSymbol animator] setAlphaValue:RMDragAnimationOutAlpha];
    [ariaSymbol setNeedsDisplay:YES];
